...
/**
 * A list item that can be swiped to reveal action buttons.
 * Supports both left and right swipe gestures.
 */
const SwipeableListItem = forwardRef<HTMLDivElement, SwipeableListItemProps>(
    ...
    return (
      ...
      >
        ...
        {leftActions.length > 0 && (
          <SwipeActions actions={wrapActions(leftActions)} side="left" />
        )}

        {/* Right Actions */}
        {rightActions.length > 0 && (
          <SwipeActions actions={wrapActions(rightActions)} side="right" />
        )}
